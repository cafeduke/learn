...
public class Latch_ThreadSync
{
   ...
   /**
    * Sync Threads - This latch is used to ensure all threads have reached a common execution point.
    */
   private CountDownLatch latchSync = null;

   /**
    * Count Threads - This latch is used to ensure all threads have finished executing.
    */
