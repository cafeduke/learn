   ...
   public static void waitForAllResources (ResourceManager manager[], int count[])
   {
      ...
      while (!acquiredAllResources)
      {
         ...
         for (int i = 0; i < manager.length; ++i)
         {
            ...
            {
               /**
                * Acquiring count[i] resources for manager[i] failed. Which means previous (0 to i-1) resource acquisition cannot be used.
                * Should not hold and wait for more resources. So, release the previously acquired resources. Sleep for some time and try again.
                */
